const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Appheader-DjQ74BVA.js","assets/IncrementComponent-3KFjqHKX.js","assets/IncrementComponent-DnmV_pMZ.css","assets/ShoppingCart-BbB3OjZU.js","assets/ShoppingCart-BGdrrHJM.css","assets/Appheader-DasHwPE1.css","assets/ProductCard-DePn33rK.js","assets/ProductCard-DoIaxyto.css"])))=>i.map(i=>d[i]);
...
const _Users_lukeatkinson_coyle_Desktop_repos_eccomerce_site_components_AppHeader_Appheader_AppHeader = () => __vitePreload(() => import('./Appheader-DjQ74BVA.js'),true              ?__vite__mapDeps([0,1,2,3,4,5]):void 0).then((mod) => mod.AppHeader);
const _Users_lukeatkinson_coyle_Desktop_repos_eccomerce_site_components_IncrementComponent_IncrementComponent_IncrementComponent = () => __vitePreload(() => import('./IncrementComponent-3KFjqHKX.js').then(n => n.d),true              ?__vite__mapDeps([1,2]):void 0).then((mod) => mod.IncrementComponent);
const _Users_lukeatkinson_coyle_Desktop_repos_eccomerce_site_components_ProductCard_ProductCard_ProductCard = () => __vitePreload(() => import('./ProductCard-DePn33rK.js'),true              ?__vite__mapDeps([6,1,2,7]):void 0).then((mod) => mod.ProductCard);
const _Users_lukeatkinson_coyle_Desktop_repos_eccomerce_site_components_ShoppingCart_ShoppingCart_ShoppingCart = () => __vitePreload(() => import('./ShoppingCart-BbB3OjZU.js'),true              ?__vite__mapDeps([3,1,2,4]):void 0).then((mod) => mod.ShoppingCart);
__pwRegistry.initialize({ _Users_lukeatkinson_coyle_Desktop_repos_eccomerce_site_components_AppHeader_Appheader_AppHeader,
  _Users_lukeatkinson_coyle_Desktop_repos_eccomerce_site_components_IncrementComponent_IncrementComponent_IncrementComponent,
  _Users_lukeatkinson_coyle_Desktop_repos_eccomerce_site_components_ProductCard_ProductCard_ProductCard,
  _Users_lukeatkinson_coyle_Desktop_repos_eccomerce_site_components_ShoppingCart_ShoppingCart_ShoppingCart });

export { getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-DyEZL--u.js.map
